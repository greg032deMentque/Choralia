...
describe('SongListDetailComponent', () => {
  ...
  it("n'effectue aucun appel HTTP et affiche une erreur inline quand l'id de route est absent ou invalide", () => {
    const fixture = TestBed.createComponent(SongListDetailComponent);
    const component = fixture.componentInstance;

    fixture.detectChanges();

    httpMock.expectNone(req => req.url.includes('/lists-chants'));
    expect(component.loading()).toBe(false);
    expect(component.error()).toBe('Identifiant de liste invalide.');
    expect(component.songList()).toBeNull();
  });
});
